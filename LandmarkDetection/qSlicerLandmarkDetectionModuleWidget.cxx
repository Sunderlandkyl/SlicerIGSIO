...
void qSlicerLandmarkDetectionModuleWidget::updateWidgetFromMRML()
{
  ...
  d->stylusTipNodeSelector->setCurrentNode(d->LandmarkDetectionNode->GetInputTransformNode());
  d->stylusTipNodeSelector->blockSignals(wasBlocking);

  /*d->referenceNodeSelector->setCurrentNode(d->LandmarkDetectionNode->GetRef)*/ // TODO: parameter
  /*d->useMarkupsReferenceCheckBox->setCurrentNode(d->LandmarkDetectionNode->GetRef)*/ // TODO: parameter
  ...
  d->minimumLandmarkDistanceDoubleSpinBox->setValue(d->LandmarkDetectionNode->GetMinimunDistanceBetweenLandmarksMm());
  d->minimumLandmarkDistanceDoubleSpinBox->blockSignals(wasBlocking);

  if (d->LandmarkDetectionNode->GetLandmarkDetectionInProgress())
  {
...
void qSlicerLandmarkDetectionModuleWidget::updateMRMLFromWidget()
{
  ...
  /*d->LandmarkDetectionNode->SetAndObserveReferenceTransformNode(vtkMRMLTransformNode::SafeDownCast(???);*/ // TODO
  // TODO: Also add the checkbox
  ...
  d->LandmarkDetectionNode->SetMinimunDistanceBetweenLandmarksMm(d->minimumLandmarkDistanceDoubleSpinBox->value());
}
